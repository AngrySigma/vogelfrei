...
| Weighted net | - | 0 | Training | 15sp | 15sp |
| ***War flail (2H)*** | d8 | 3 | — | 20sp | 10sp |
| ***Longbow*** | d6 | - | Training | 45sp | - |

The Longbow uses ranges 50'—600'—900' and the ammunition rules on the [Ranged Weapons](Ranged%20Weapons.md) page. A century ago it was the best missile weapon in Europe and every English parish was required to practise with it; by now the law is a dead letter, the practice grounds are pasture, and the men who could draw one are dead. It takes a lifetime to make an archer and six weeks to make a musketeer, which is the whole argument.
...
This never extends to a **Polearm**. A halberd kills by leverage through both hands, and a man holding one in a single fist is holding a heavy stick.

| Weapon | Effects |
| --- | --- |
| Mancatcher | On a hit, the victim must save versus Paralyzation or become helpless. The wielder is also helpless against other attacks while holding the victim. |
| Weighted net | On a hit, the victim must save versus Paralyzation or become helpless. The victim may save again each Round. |
| War flail | Ignores the benefit of a shield or buckler; the head comes round it. |
