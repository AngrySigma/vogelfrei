...
A Magic-User can only cast a spell that is currently prepared. Casting the spell expends it: the spell is wiped from memory and cannot be cast again until it is prepared anew. A prepared spell takes effect automatically — there is no roll to cast it. Casting one spell takes a character’s whole action for the round.
