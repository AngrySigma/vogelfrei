...
The reverse of this spell, **Obscure Aura**, hides the magic aura of a legitimate magical item. A Magic-User casting [Detect Magic](Detect%20Magic.md) and actually handling the item is permitted a saving throw versus Magic to see the magical aura of the item.
