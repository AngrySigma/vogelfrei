...
A missile of magical energy shoots forth from the caster’s fingertip and strikes its target, dealing damage equal to 1d3 per level of the caster (so a second-level Magic-User deals 2d3 points of damage). The missile strikes unerringly, even if the target is in melee combat or has less than total cover or total concealment. Specific parts of a creature cannot be singled out. The missile's damage is not affected by the target's [Armor Rating](../../../../../Equipment/Armor.md).
