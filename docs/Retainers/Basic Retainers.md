...
| Retainer  | Daily Wage | Monthly Wage | Live-in Wage | Space | Treasure Share |
| --------- | ---------- | ------------ | ------------ | ----- | -------------- |
| Linkboy   | 4sp        | 40sp         | 30sp         | 10'   | -              |
| Laborer   | 6sp        | 60sp         | 40sp         | 10'   | -              |
| Mercenary | 10sp       | 100sp        | 75sp         | 10'   | 0.2            |
| Henchman  | -          | -            | -            | 10'   | 0.5            |
...
#### Mercenary
Mercenaries are paid warriors-for-hire, treated effectively as 0 level Warriors without Career. If recruited from the citizenry, all equipment must be supplied by their employers.
