...
Any orders assigned by anyone except the direct employer can be freely ignored by the Retainer. For actual combat situations, see the section on Morale in the [Combat Actions](../Encounters/Combat%20Actions.md).
