...
##### Attack
A Character can move their normal combat speed and perform an attack any enemy within their range. Vogelfrei uses descending Armor Class based on a Character's skills, and implements Armor to block damage. To determine the attack success and the inflicted damage, the following actions are performed:
